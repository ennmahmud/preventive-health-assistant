...
export default function SettingsPage() {
  ...
  const handleDelete = () => { deleteAccount(); navigate('/login', { replace: true }); };
  ...
  return (
    <div className={styles.page}>
      ...
      <Group title="Account">
        ...
        <Row label="Member since" value={user?.createdAt ? new Date(user.createdAt).toLocaleDateString('en-GB', { month: 'long', year: 'numeric' }) : '—'} />
      </Group>
      ...
      <Group title="Security">
        <div className={styles.pwdSection}>
          ...
          <form className={styles.pwdForm} onSubmit={handleChangePwd} noValidate>
            ...
            <button className={`${styles.pwdBtn} ${pwdSaved ? styles.pwdBtnDone : ''}`} type="submit">
      ...
      <Group title="Account Actions">
        ...
        {!confirmDelete ? (
          ...
          <div className={styles.confirmRow}>
            <span className={styles.confirmText}>This permanently deletes your account and all local data. Are you sure?</span>
            <div className={styles.confirmBtns}>
              <button className={styles.confirmYes} onClick={handleDelete}>Delete Forever</button>
